  ...
  const handleGoogle = () => {
    ...
    setTimeout(() => {
      ...
      loginUser({
        ...
        avatar: 'https://lh3.googleusercontent.com/a/ACg8ocIq8d1-wN-j-7_w-w', // Example avatar
      });
            ...
            <View style={styles.footer}>
              {mode === 'signin' ? (
                <Text style={[styles.footerText, { color: colors.textMuted }]}>
                  ...
                  <Text style={[styles.footerLink, { color: colors.accent }]} onPress={() => changeMode('signup')}>Sign Up</Text>
                </Text>
              ) : mode === 'signup' ? (
                <Text style={[styles.footerText, { color: colors.textMuted }]}>
                  Already have an account?{' '}
                  <Text style={[styles.footerLink, { color: colors.accent }]} onPress={() => changeMode('signin')}>Sign In</Text>
                </Text>
              ) : (
                <Text style={[styles.footerLink, { color: colors.accent }]} onPress={() => changeMode('signin')}>
                  Back to Sign In
                </Text>
              )}
            </View>
