...
import { BottomSheetModal } from './BottomSheetModal'; // Resolved to .web
...
export const TrainingProgramsListModal: React.FC<TrainingProgramsListModalProps> = ({ visible, onClose }) => {
  ...
  const parseDuration = (durationStr: string) => parseInt(durationStr.replace(/[^0-9]/g, '')) || 0;
              ...
              <TouchableOpacity 
                style={[
                  ...
                  { 
                    ...
                    borderColor: activeFiltersCount > 0 ? colors.accent : 'transparent',
                    borderWidth: 2 
                  },
                  webStyles.pointer
                ]}
            ...
            {filteredPrograms.length === 0 ? (
              ...
              <View style={styles.grid}>
                {filteredPrograms.map((program) => (
                  <TouchableOpacity 
                    key={program.id}
                    style={[styles.cardContainer, webStyles.pointer, webStyles.cardHover]}
                  ...
                  >
                    <View style={[styles.card, { backgroundColor: isDark ? '#1F2937' : '#FFFFFF' }]}>
                      ...
                      <View style={styles.cardContent}>
                        ...
                        <Text style={styles.cardTrainer}>By {program.trainer}</Text>
